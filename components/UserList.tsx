    ...
    <div className="w-full md:w-80 bg-gradient-to-b from-amber-50 to-red-50 dark:from-gray-900 dark:to-red-950 border-r border-amber-200 dark:border-red-900 flex flex-col shadow-xl">
      ...
      <div className="p-3 md:p-4 border-b border-amber-200 dark:border-red-900 bg-white/50 dark:bg-black/20 backdrop-blur-sm">
        <div className="flex items-center justify-between mb-3">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <h3 className="font-semibold text-red-900 dark:text-yellow-400 text-sm md:text-base truncate">
                {currentUser.username}
              </h3>
              <p className="text-xs text-red-700 dark:text-yellow-600">
                View profile
              </p>
            </div>
          </div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm border-2 border-amber-300 dark:border-red-800 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-red-400 dark:placeholder-yellow-600"
        />
      </div>
          ...
          users.map((user) => (
            ...
            >
              <div className="flex items-center gap-2 md:gap-3">
                ...
                >
                  <div className="font-semibold text-red-900 dark:text-yellow-400 truncate text-sm md:text-base">
                    {user.username}
                  </div>
                  <div className="text-xs md:text-sm text-red-700 dark:text-yellow-600 truncate">
