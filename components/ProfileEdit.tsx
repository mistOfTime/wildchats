      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        ...
        <div className="px-6 md:px-8 pb-6 md:pb-8">
          ...
          <div className="space-y-4">
            ...
            {previewUrl && (
              <div className="flex items-center justify-between p-3 bg-amber-100 dark:bg-amber-950/50 rounded-xl border-2 border-amber-300 dark:border-amber-800">
                <span className="text-sm text-amber-900 dark:text-amber-200">Profile picture uploaded</span>
                <button
                  type="button"
                  onClick={() => {
            ...
            {coverPreviewUrl && (
              <div className="flex items-center justify-between p-3 bg-amber-100 dark:bg-amber-950/50 rounded-xl border-2 border-amber-300 dark:border-amber-800">
                <span className="text-sm text-amber-900 dark:text-amber-200">Cover photo uploaded</span>
                <button
                  type="button"
                  onClick={() => {
